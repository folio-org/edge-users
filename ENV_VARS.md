...
| `FOLIO_CLIENT_OKAPIURL` | http://localhost:9130 | false | Okapi base URL used for outbound FOLIO service calls. This must be set to the reachable Okapi URL for the deployment environment. |
